...
<html>
  <head><title>compoundInterestResult3</title></head>
  <body>
    <%= "<h1 align=\"center\">compoundInterestResult3</h1>" %>
    <%= "<h3>" %>

    <jsp:useBean id="bean" class="org.javaturk.wap.jsp.ch05.CompoundInterestBean"/>
    <jsp:setProperty name="bean" property="principal"/>
    <jsp:setProperty name="bean" property="interestRate"/>
    <jsp:setProperty name="bean" property="years"/>
