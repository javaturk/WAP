...
public class AsyncRequestProcessor implements Runnable {
	...
	public AsyncRequestProcessor(AsyncContext asyncContext, int limit) {
...
//		printResponseToConsole();
	...
	private void printResponseToConsole() {
		...
		System.out.println("It took " + timeFormatted + " ms. to calculate this using Sieve of Eratosthenes algorithm. <br/>");
