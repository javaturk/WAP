...
public class ParameterServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        out.println("<html>");
        out.println("<head>");
        out.println("<title>ParameterServlet</title>");
        out.println("</head>");
        out.println("<body>");
        out.println("<h1 align=\"center\">ParameterServlet</h1>");
        out.println("<h3>");
        out.println("Please fill out the following form. Thank you.");
        printForm(out);
        out.println("<p><h4><a href=\"SourceCodeServlet?name=org.javaturk.wap.ch07.ParameterServlet\">For Source Code</h4></a>");
        out.println("</body>");
        out.println("</html>");
    ...
    private void printForm(PrintWriter out){
        out.println("<form method=POST action=ParameterServlet>");
        ...
        out.println("<input type=radio name=sex value=\"F\"> Female</td>");
        out.println("</tr>");
