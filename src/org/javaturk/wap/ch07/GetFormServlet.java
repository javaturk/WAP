...
public class GetFormServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        out.println("<html>");
        out.println("<head>");
        out.println("<title>GetFormServlet</title>");
        out.println("</head>");
        out.println("<body>");
        out.println("<h1 align=\"center\">GetFormServlet</h1>");
        out.println("<h3>");
        printParameters(out, request);
        out.println("<p><h4><a href=\"SourceCodeServlet?name=org.javaturk.wap.ch07.GetFormServlet\">For Source Code</h4></a>");
        out.println("</body>");
        out.println("</html>");
