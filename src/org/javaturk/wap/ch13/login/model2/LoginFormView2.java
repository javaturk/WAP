...
@WebServlet(urlPatterns={"/loginForm2.view"})
public class LoginFormView2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<P><h4><a href=\"SourceCodeServlet?name=org.javaturk.wap.ch13.login.model2.LoginFormView2\">For Source Code</h4></a>");
		out.println("</BODY>");
		out.println("</HTML>");
		out.close();
	}
